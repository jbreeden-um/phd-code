...
t = 0;
x1 = randn(3,1); x1 = x1/norm(x1); %x1 = O_Earth_from_Sol*[cos(omega_Earth*t); sin(omega_Earth*t); 0]; % inertial frame
y1 = randn(3,1); y1 = y1/norm(y1); %y1 = constants.p1;
...
figure(1); clf;
PlotCone(x1, acos(constants.ctheta));
hold on;
[s1, s2, s3] = sphere(20);
